...
class productimp_Visualization_Viewmaker {
    ...
    public function createView()
    {
        ...
        wp_enqueue_script('productimp_app-vue', plugin_dir_url( __FILE__ ) . 'dist/chunk-vendors.5566ca25.js', [], '1.0', true);
        wp_enqueue_script('productimp_app-vue', plugin_dir_url( __FILE__ ) . 'dist/app.fbd742dd.js', [], '1.0', true);
