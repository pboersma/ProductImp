...
class productimp_Visualization_Viewmaker {
    ...
    public function createView()
    {
        ...
        wp_enqueue_script('productimp_app-vue', plugin_dir_url( __FILE__ ) . 'dist/js/app.c9a5ac7c.js', [], '1.0', true);
        wp_enqueue_style('productimp_app-styling', plugin_dir_url( __FILE__ ) . 'dist/css/app.692b3882.css', [], '1.0', 'all');
