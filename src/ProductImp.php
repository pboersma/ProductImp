...
class ProductImp {
    ...
    public function addMenu()
    {
        add_menu_page(
            ...
            function(){
                echo "<div id='app'></div>";
                wp_enqueue_script('productimp_app-vue', plugin_dir_url( __FILE__ ) . 'dist/index-2711257b.js', [], '1.0', true);
                wp_enqueue_style('productimp_app-styling', plugin_dir_url( __FILE__ ) . 'dist/index-8c1ace62.css', [], '1.0', 'all');
